...
export default function panAndZoom(WrappedComponent) {
    ...
    return _a = /** @class */ (function (_super) {
            ...
            PanAndZoomHOC.prototype.render = function () {
                var _a = this.props, scaleFactor = _a.scaleFactor, tempX = _a.x, tempY = _a.y, tempScale = _a.scale, minScale = _a.minScale, maxScale = _a.maxScale, onPanStart = _a.onPanStart, onPanMove = _a.onPanMove, onPanEnd = _a.onPanEnd, onZoom = _a.onZoom, onPanAndZoom = _a.onPanAndZoom, renderOnChange = _a.renderOnChange, passOnProps = _a.passOnProps, ignorePanOutside = _a.ignorePanOutside, disableScrollZoom = _a.disableScrollZoom, zoomEndTimeout = _a.zoomEndTimeout, onZoomEnd = _a.onZoomEnd, shiftBoxZoom = _a.shiftBoxZoom, onBoxStart = _a.onBoxStart, onBoxMove = _a.onBoxMove, onBoxEnd = _a.onBoxEnd, other = __rest(_a, ["scaleFactor", "x", "y", "scale", "minScale", "maxScale", "onPanStart", "onPanMove", "onPanEnd", "onZoom", "onPanAndZoom", "renderOnChange", "passOnProps", "ignorePanOutside", "disableScrollZoom", "zoomEndTimeout", "onZoomEnd", "shiftBoxZoom", "onBoxStart", "onBoxMove", "onBoxEnd"]);
                var x = this.props.x;
                var y = this.props.y;
